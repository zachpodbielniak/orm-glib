 ...
 *
 * Example: Query Builder with PostgreSQL
 * =======================================
 *
 * Prerequisites:
...
main (int argc, char **argv)
{
    ...
    g_print ("orm-glib PostgreSQL Query Builder Example\n");
    g_print ("==========================================\n\n");
    ...
    /* Create table */
    {
        ...
        g_autofree gchar *drop_sql = orm_ddl_compiler_compile_drop_table (ddl, table, TRUE, FALSE);
